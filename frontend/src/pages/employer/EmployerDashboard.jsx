        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-500 font-medium tracking-wide">Loading Portfolio...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div>
                        <span className="text-indigo-600 font-black text-xs uppercase tracking-widest mb-2 block">
                            Employer Portal
                        </span>
                    ...
                    <Link
                        ...
                        className="flex items-center justify-center gap-2 px-8 py-4 bg-indigo-600 text-white font-black rounded-2xl hover:bg-indigo-700 hover:shadow-2xl hover:shadow-indigo-200 transition-all active:scale-95 group"
                    >
                        <IconPlus />
                        Post a New Job
                    </Link>
                ...
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-12">
                    ...
                    {/* Active Job Posts */}
                    <div className="bg-white p-8 rounded-3xl shadow-xl shadow-gray-100 border border-gray-50 relative overflow-hidden group hover:border-indigo-100 transition-all">
                        ...
                        <Link to="/employer/job-posts" className="mt-6 inline-flex text-indigo-600 font-black text-sm hover:underline items-center gap-1 group">
                            Manage Jobs
                    ...
                    <div className="bg-white p-8 rounded-3xl shadow-xl shadow-gray-100 border border-gray-50 relative overflow-hidden group hover:border-blue-100 transition-all">
                        ...
                        <div className="flex items-end gap-3">
                            ...
                            <span className="mb-2 text-blue-500 font-bold text-sm">Reviewing 12</span>
                        </div>
                        <Link to="/employer/applications" className="mt-6 inline-flex text-blue-600 font-black text-sm hover:underline items-center gap-1 group">
                            View Applicants
                            <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </Link>
                    </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 bg-gray-50 rounded-3xl p-10 border border-gray-100 flex flex-col justify-center min-h-[300px]">
                        <div className="max-w-md">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button className="px-6 py-3 text-indigo-600 font-black rounded-xl hover:bg-indigo-50 transition-all text-sm">
                                    Contact Support
                                </button>
                            </div>
                        </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-10 text-white relative overflow-hidden flex flex-col justify-between">
                        <div className="relative z-10">
                            ...
                            <button className="w-full py-4 bg-white text-indigo-600 font-black rounded-2xl hover:shadow-2xl transition-all">
                                Upgrade to Pro
                            </button>
                        </div>
