                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.email ? 'border-red-300 focus:ring-red-100' : 'border-gray-200 focus:ring-indigo-100'} rounded-2xl text-gray-900 font-bold placeholder-gray-400 focus:outline-none focus:ring-4 focus:bg-white focus:border-indigo-600 transition-all`}
                                    {...register("email", {
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-2 ml-1">
                                ...
                                <a href="#" className="text-xs font-black text-indigo-600 hover:underline">Forgot?</a>
                            </div>
                            <div className="relative group">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none group-focus-within:text-indigo-600 transition-colors">
                                    <IconLock />
                                ...
                                <input
                                    type="password"
                                    placeholder="••••••••"
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.password ? 'border-red-300 focus:ring-red-100' : 'border-gray-200 focus:ring-indigo-100'} rounded-2xl text-gray-900 font-bold placeholder-gray-400 focus:outline-none focus:ring-4 focus:bg-white focus:border-indigo-600 transition-all`}
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 bg-indigo-600 text-white py-4 rounded-2xl font-black hover:bg-indigo-700 shadow-xl shadow-indigo-100 transition-all active:scale-95 disabled:opacity-50"
                        >
                            {isSubmitting ? (
