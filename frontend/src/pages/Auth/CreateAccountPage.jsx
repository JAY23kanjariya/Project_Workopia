    ...
    return (
        <div className="min-h-screen bg-white lg:bg-gray-50 flex items-center justify-center p-6">
            <div className="w-full max-w-2xl">
                ...
                <div className="bg-white lg:shadow-2xl lg:shadow-indigo-100/50 rounded-3xl p-8 md:p-12 border border-transparent lg:border-gray-100">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <label className={`relative flex items-center justify-center p-4 rounded-2xl border-2 cursor-pointer transition-all ${watch("role_id") === 3 ? 'border-indigo-600 bg-indigo-50' : 'border-gray-100 bg-gray-50'}`}>
                                    <input type="radio" value="3" {...register("role_id", { required: "Please select a role" })} className="absolute opacity-0" />
                                    <span className={`font-bold ${watch("role_id") === 3 ? 'text-indigo-600' : 'text-gray-500'}`}>Candidate</span>
                                </label>
                                <label className={`relative flex items-center justify-center p-4 rounded-2xl border-2 cursor-pointer transition-all ${watch("role_id") === 2 ? 'border-indigo-600 bg-indigo-50' : 'border-gray-100 bg-gray-50'}`}>
                                    <input type="radio" value="2" {...register("role_id", { required: "Please select a role" })} className="absolute opacity-0" />
                                    <span className={`font-bold ${watch("role_id") === 2 ? 'text-indigo-600' : 'text-gray-500'}`}>Employer</span>
                                </label>
                            </div>
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.name ? 'border-red-300' : 'border-gray-200'} rounded-2xl text-gray-900 font-bold focus:ring-4 focus:ring-indigo-100 focus:bg-white focus:border-indigo-600 transition-all outline-none`}
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.email ? 'border-red-300' : 'border-gray-200'} rounded-2xl text-gray-900 font-bold focus:ring-4 focus:ring-indigo-100 focus:bg-white focus:border-indigo-600 transition-all outline-none`}
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    type="password"
                                    placeholder="••••••••"
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.password ? 'border-red-300' : 'border-gray-200'} rounded-2xl text-gray-900 font-bold focus:ring-4 focus:ring-indigo-100 focus:bg-white focus:border-indigo-600 transition-all outline-none`}
                        ...
                        <div className="md:col-span-1">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    type="password"
                                    placeholder="••••••••"
                                    className={`block w-full pl-12 pr-4 py-4 bg-gray-50 border ${errors.confirmPassword ? 'border-red-300' : 'border-gray-200'} rounded-2xl text-gray-900 font-bold focus:ring-4 focus:ring-indigo-100 focus:bg-white focus:border-indigo-600 transition-all outline-none`}
