            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        {/* User Profile Pill */}
                        <div className="flex items-center gap-3 p-1 pl-1 pr-3 sm:pr-4 bg-gray-50/50 hover:bg-white hover:shadow-sm hover:border-gray-200 rounded-full border border-transparent transition-all cursor-default group">
                            ...
                            <div className="flex flex-col">
                                <span className="text-sm font-bold text-gray-800 leading-none truncate max-w-[80px] sm:max-w-[120px]">
                                    {name}
                                </span>
